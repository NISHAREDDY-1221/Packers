...
export const WorkOrders: React.FC = () => {
  ...
  const supervisors = useMemo(
    () =>
      Array.from(
        new Set(workOrders.map((wo) => wo.supervisor?.name || wo.supervisorId)),
      ),
    [workOrders],
  );
  const teams = useMemo(
